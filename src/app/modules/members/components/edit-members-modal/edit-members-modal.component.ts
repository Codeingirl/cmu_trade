...
import { Customer } from 'src/app/modules/topup/_models/customer.model';
...
export class EditMembersModalComponent implements OnInit, OnDestroy {
  @Input() id: number;
  isLoading$;
  customer: Customer;
  formGroup: FormGroup;
  ...
  constructor(
    private customersService: MembersService,

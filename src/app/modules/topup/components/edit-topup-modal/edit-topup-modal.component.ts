...
@Component({
  selector: 'app-edit-topup-modal',
  templateUrl: './edit-topup-modal.component.html',
  styleUrls: ['./edit-topup-modal.component.scss'],
...
export class EditTopUpModalComponent implements OnInit, OnDestroy {
  @Input() id: number;
  isLoading$;
  customer: Customer;
  formGroup: FormGroup;

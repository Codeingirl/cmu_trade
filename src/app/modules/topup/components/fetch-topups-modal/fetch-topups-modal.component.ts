...
@Component({
  selector: 'app-fetch-topups-modal',
  templateUrl: './fetch-topups-modal.component.html',
  styleUrls: ['./fetch-topups-modal.component.scss']
})
export class FetchTopUpsModalComponent implements OnInit, OnDestroy {
  @Input() ids: number[];
  customers: Customer[] = [];
  isLoading = false;

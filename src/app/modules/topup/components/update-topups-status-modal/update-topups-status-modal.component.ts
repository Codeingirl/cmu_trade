...
@Component({
  selector: 'app-update-topups-status-modal',
  templateUrl: './update-topups-status-modal.component.html',
  styleUrls: ['./update-topups-status-modal.component.scss']
})
export class UpdateTopUpsStatusModalComponent implements OnInit, OnDestroy {
  @Input() ids: number[];
  status = 2;
  customers: Customer[] = [];
  isLoading = false;
